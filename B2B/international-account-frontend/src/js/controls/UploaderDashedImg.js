    ...
    */
    ...
    X.prototype.controls.widget("UploaderDashedImg", function (controlType) {
        ...
        UploaderDashedImg.prototype.props = function() {
            ...
            this.errorText          =   {
                                            Q_EXCEED_SIZE_LIMIT:        '图片大小不能超出'+ this.options.size +'MB',
                                            F_EXCEED_SIZE:              '图片大小不能超出'+ this.options.size +'MB',
        ...
        UploaderDashedImg.prototype.loadTemplate = function() {
            var html = [
                    ...
                    '   <span><label class="error js-error"></label></span>',
                    '</div>',
        ...
        UploaderDashedImg.prototype.doRender = function() {
            ...
            if (!img.length) {
                img = $('<img>')
                this.elem.children().children(':eq(0)').before(img)
            }
        ...
        UploaderDashedImg.prototype.error = function() {
            ...
            this.uploader.on( 'error', function( type ) {
                me.errorPlace.text(me.errorText[type])[0].style.display = 'inline'
                me.inputHidden.next('label.error').hide()
            });
        };
