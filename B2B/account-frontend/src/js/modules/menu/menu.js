X.define("modules.menu.menu",["model.menuModel","modules.menu.breadCrumb", "model.messageModel", 'model.infoManageModel'],function (menuModel, breadCrumb, messageModel, infoManageModel) {
