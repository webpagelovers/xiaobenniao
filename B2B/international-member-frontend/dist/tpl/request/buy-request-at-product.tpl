    ...
    <form class="js-buyRequestAtProduct-form">
        ...
        <div class="pb40">
            <p class="disib mr70 por w64p">
                <input type="text" class="eeeBorder h45 lh45 pl10 f16 w100p js-prodName" name="productTitle" data-property-name="productTitle" data-control-type="TextBox" placeholder="!!!Error!!!">
                <label class="js-error redFont poa l0 t52"></label>
            </p>
            <p class="disib por w15p">
                <input type="text" class="eeeBorder h45 lh45 pl10 f16 w100p" placeholder="!!!Error!!!" name="quantity" data-property-name="quantity" data-control-type="TextBox">
                <label class="js-error redFont poa w200 l0 t52"></label>
            </p>
            <p class="disib por w15p">
                <input type="text" class="eeeBorder h45 lh45 pl10 f16 w100p ml_4" placeholder="!!!Error!!!" name="unit" data-property-name="unit" data-control-type="TextBox">
                <label class="js-error redFont poa w200 l0 t52"></label>
            </p>
        ...
        <div class="bgcff eeeBorder mh600 por" style="padding:40px">
            <div>
                <div class="w200 h200 dashedCc por inlineb vat request-img-delete">
                    ...
                    <img class="w200 h200 poa l0 t0 js-imgs" name="productImageDefault" data-property-name="productImageDefault" data-control-type="TextBox">
                </div>
                <div class="w200 h200 dashedCc por inlineb ml20 vat" name="productImage" data-property-name="productImage" data-control-type="Upload">
                    <a class="block tac pt40 w200 h160 curp" style="margin-bottom: -200px;">
                        ...
                        <p class="w100 colcc f16 lh26 tac center">!!!Error!!!</p>
            ...
            <div class="por mt20" style="height: 385px;">
                <textarea class="eeeBorder poa l0 t0  js-description" name="description" data-property-name="description" data-control-type="TextBox" style="padding: 1px;height:345px;width:100%;"></textarea>
