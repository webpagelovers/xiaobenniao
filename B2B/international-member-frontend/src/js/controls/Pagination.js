(function ($, X) {
    ...
    X.prototype.controls.widget("Pagination", function (controlType) {
        ...
        Pagination.prototype.create = function () {
            ...
            var oSpan = $('<span class="page_line">'+ $.i18n.prop('controls_common') +' </span>');
            var oEm = $('<em>' + this.totalCount+ '</em>');
            this.elementChild.totalCount = oEm;
            oSpan.append(oEm);
            oSpan.append($.i18n.prop('controls_item_space'));
            firstLi.append(oSpan);
            firstLi.append('<span>'+ $.i18n.prop('controls_perpage') +'</span>');
            // 下拉 每页显示 X 条
            ...
            firstLi.append($.i18n.prop('controls_item'));
            oUl.append(firstLi);

            // 首页 按钮
            var oFirstPage = $('<li class="firstPage">'+ $.i18n.prop('controls_homepage') +'</li>');
            ...
            // 尾页 按钮
            var oLastPage = $('<li class="lastPage">'+ $.i18n.prop('controls_lastpage') +'</li>');
            ...
            oUl.append(oStateLi);
            // 确认按钮
            var oConfirmBtn = $('<li class="toPage">'+ $.i18n.prop('controls_sure') +'</li>');
