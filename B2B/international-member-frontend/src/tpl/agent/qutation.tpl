    ...
    <form class="center bgcff mt16 js-qutationForm" style="width:937px;">
        <div style="padding:30px 30px 50px 30px">
            ...
            <div class="mb30 por">
                ...
                <input type="text" name="name" maxlength="128" placeholder="qutation_Name" class="shadow-input br5 h36 lh36 w300" data-property-name="name" data-control-type="TextBox"/>
                <span class="poa l0 b_20"><label class="js-error"></label></span>
            </div>
            <div class="mb30 por">
                <p class="f14 mb5">Phone *</p>
                <input type="text" maxlength="11" name="phone" placeholder="qutation_phone"  class="shadow-input br5 h36 lh36 w300" data-property-name="phone" data-control-type="TextBox"/>
                <span class="poa l0 b_20"><label class="js-error"></label></span>
            </div>
            <div class="mb30 por">
                <p class="f14 mb5">Email *</p>
                <input type="text" name="email" maxlength="60" placeholder="qutation_mail" class="shadow-input br5 h36 lh36 w300" data-property-name="email" data-control-type="TextBox"/>
                <span class="poa l0 b_20"><label class="js-error"></label></span>
