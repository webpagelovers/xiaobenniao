X.define("modules.statistics.searchForHotWords", ["model.statisticsModel"], function (statisticsModel) {

    //初始化视图对象
    var view = X.view.newOne({
        el: $(".xbn-content"),
        url: X.config.statistics.tpl.searchForHotWords
    });
    ...
    ctrl.getData = function (_data) {
        statisticsModel.getHotWordsList(_data, function (result) {
