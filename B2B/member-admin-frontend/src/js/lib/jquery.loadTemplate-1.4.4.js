(function ($) {
    ...
    function bindData(template, data, settings) {
        ...
        processElements("data-content-attach", template, data, settings, function ($elem, value) {
            new Uploader($elem, {files: value, needUpload: false})
        });
