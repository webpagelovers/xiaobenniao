    ...
    List.prototype = $.extend(List.prototype,{
        ...
        loadData : function (condition) {
            ...
            function generateData() {
                var list = that.option.dataSource,
                    page = that.option.pageInfo

                page.pageNo     = that.pagination.pageNo
                page.totalCount = list.length
                page.totalPages = Math.ceil(list.length / page.pageSize)

                var newList = list.slice( (page.pageNo - 1) * page.pageSize, page.pageNo * page.pageSize ),
                    data    = {list: newList, page: page}
