...
const List = () => import(/* webpackChunkName: "logistics-plan" */ './list.vue');
const Add = () => import(/* webpackChunkName: "logistics-plan" */ './add.vue');
const Detail = () => import(/* webpackChunkName: "logistics-plan" */ './detail.vue');
