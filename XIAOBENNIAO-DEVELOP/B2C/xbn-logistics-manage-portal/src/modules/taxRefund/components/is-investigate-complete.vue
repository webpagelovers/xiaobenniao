<template>
    <nt-dialog title="此次函调是否完成？" :visible.sync="isShow" size="tiny" :close-on-click-modal="false">
        <nt-form :model="postData" ref="postData" label-width="163px">
            <nt-form-item label="" prop="isInvestigateComplete" :rules="[{required: true, message: '此项不能为空', trigger: 'change' }]">
                <nt-radio-group v-model="postData.isInvestigateComplete">
                    <nt-radio key="1" label="函调完成"></nt-radio>
                    <nt-radio key="2" label="函调失败"></nt-radio>
                </nt-radio-group>
            </nt-form-item>
        </nt-form>
