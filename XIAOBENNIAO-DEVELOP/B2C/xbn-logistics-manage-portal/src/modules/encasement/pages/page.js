...
const PageList = () => import(/* webpackChunkName: "githuber" */ './list.vue');
const PageDetail = () => import(/* webpackChunkName: "githuber" */ './detail.vue');
const PageAudit = () => import(/* webpackChunkName: "githuber" */ './audit.vue');
const PageEdit = () => import(/* webpackChunkName: "githuber" */ './edit.vue');
