...
X.prototype.controls.widget("Pagination",function (controlType){    
    ...
    */
    ...
    function Pagination(elem, opt) {
        ...
        this.dataSource = opt.dataSource || [{key:10,value:10},{key:20,value:20},{key:30,value:30},{key:50,value:50}];
    ...
    Pagination.prototype.create = function () {
        ...
        // 共 X 条
        var firstLi = $('<li class="li-select-page"></li>').hide();
        ...
        var cmb = X.prototype.controls.getControl("ComboBox",selectLi,{dataSource:self.dataSource,
        ...
        // 页码状态 input
        var oStateLi = $('<li class="li-select-page"></li>').hide();
        oStateLi.append('共 ');
