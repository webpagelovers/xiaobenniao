...
X.prototype.controls.widget("Accondion",function (controlType) {
    ...
    */
    Accondion.prototype.getLiItemFromResult = function (result, level) {
        ...
        if(result.visible==true || result.visible==undefined){
    ...
    Accondion.prototype.getLiItemFromResultWithChild = function (result, level) {
        ...
        var $div = $('<div class="header"><span class="arrow"><i class="iconfont icon-right"></i></span><span class="txt"><i class="iconfont '+result.ico +'"></i><a class="js-name" data-x-href="'+result.code +'">' + result.name + '</a></span></div>');
    ...
    */
    ...
    Accondion.prototype.afterItemClick = function (element) {
        if(this.options.allowShrink==true){
    ...
    * @sum 更新节点的显示title    
    */
    Accondion.prototype.updateItem = function(data,html){
        if(data){
            var li = this.getItem(data);
            if(li && li.length>0){
                li.find(".js-name").html(html);
            }
        }
        return this;
    }
