<div class="js-resetPassword-wrap">
</div>
<div class="common-tpl-list js-resetPassword-tpl">
    <form action="" style="width:440px" class="form  center">
        ...
        <div class="mb28 mt40">
            <input type="text" class="cccBorder br5 f14 h34 lh36 pl10 w97p" placeholder="user_reset_email" name="email"
                   data-property-name="email" data-control-type="TextBox">
        </div>
        <div class="mb53">
            <input type="text" class="cccBorder br5 w190 f14 h34 lh36 pl10"
                   style="width: 232px; " placeholder="user_reset_code"
                   name="checkCode">
            <a href="javascript:void (0)"><img
                                src="" id="code"
                                class="intValidateImg ml10 curd js-changeCode"></a>
...
<form action="" style="width:440px" class="form">
            ...
            <div class="mb30 mt45">
                <input type="text" class="cccBorder br5 f14 h34 lh36 pl10 w97p" placeholder="user_reset_update_password" name="newPassword" id="password" data-property-name="newPassword"  data-control-type="TextBox">
            </div>
            <div class="mb30 mt45">
                <input type="text" class="cccBorder br5 f14 h34 lh36 pl10 w97p" placeholder="user_reset_update_password_confirm" name="resetCode" data-property-name="resetCode"  data-control-type="TextBox">
            </div>
            <input type="button" class="default_button f18 w100p  js-updatePassSubmit" value="Send Reset Email"  data-i18n="user_reset_update_submit"  />
</form>
</div>
</div>
...
<div class="common-tpl-list js-setSuccuss-tpl">
    <div class="mt100 tac mb400">
        ...
        <input type="button" class="default_button f18 w164 mt50  js-setSuccessButton" value="Log In Now"
               data-i18n="user_reset_success_button"/>
    </div>
</div>
