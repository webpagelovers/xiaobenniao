        ...
        generateValidate: function(type,isCheckCode) {
            ...
            var validate = {
                ...
                messages: {
                    ...
                    confirmPassword:       { required: $.i18n.prop("user_confirm_password_required"),          rangelength: $.i18n.prop("user_password_length"),  stringCheck: $.i18n.prop("user_password_invalid"), isSpace: $.i18n.prop("user_password_invalid"), confirmPassword: $.i18n.prop("user_confirm_password_invalid")},
                    checkCode:      { required: $.i18n.prop("user_verification_code_required"), verCode: $.i18n.prop("user_verification_code_error")  },
                    registTerms: {required: $.i18n.prop("user_regist_terms")}
                },
                onkeyup: false,
