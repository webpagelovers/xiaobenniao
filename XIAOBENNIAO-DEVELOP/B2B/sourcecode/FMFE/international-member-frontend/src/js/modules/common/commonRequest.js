        ...
        init:function(){
            ...
            var meta = {
                "productImage": {
                    ...
                    filePickerLabel: $.i18n.prop('promotion_category_attachChoose'),
                    cancel: true,
            ...
            ctrl.validate = {
                ...
                messages: {
                    productName: {
                        required: $.i18n.prop('promotion_category_productNameR')
                    },
                    email: {
                        required: $.i18n.prop('promotion_category_mailR'),
                        email: 'Please enter a valid E-mail address'
                    },
                    details: {
                        required: $.i18n.prop('promotion_category_descriptionR')
                    }
                },
                onkeyup: false,
            ...
            ctrl.view.el.find(".js-description").keyup(function(data) {
                ...
                if (count < 7000) {
                    ...
                    ctrl.view.el.find('#buyingRequestDescriptionInfo').html($.i18n.prop("buyingRequest_description_before") + ' <span class="redFont">' + count + '</span> ' + $.i18n.prop("buyingRequest_description_after")).show(300);
                } else {
            ...
            ctrl.view.find(".js-description").focusout(function () {
                $(this).attr('placeholder',$.i18n.prop('buyingRequest_Detail_placeholder'));
            });
