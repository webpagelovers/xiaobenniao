X.define('common.share', function () {
    ...
    function share(elem, _url, _title) {
        ...
        var aaaaa  =  generateFunctions(),
            shares =  generateSharesObj(),
            count  =  generateCountObj()

        var html = ''    
        for (var i in shares) {
            var link = shares[i]
            html += '<div class="'+ i +' ml10" href="'+ link +'" onclick="sharesGoShare(this)"><i class="shareCount"></i></div>'
