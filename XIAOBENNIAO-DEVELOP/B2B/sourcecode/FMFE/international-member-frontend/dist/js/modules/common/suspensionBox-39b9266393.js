X.define('modules.common.suspensionBox',function () {
    ...
    function suspensionBox() {
        ...
        $('#myEmail').bind("click",function(){
            ga('send', {
                hitType: 'event',
                eventCategory: 'Email',
                eventAction: 'Click',
                eventLabel: 'Click Email Icon'
            });
        });
    ...
    function addEvent() {
        ...
        $(".suspensionBox>li").hover(function () {
        ...
        $('.js-buyingRequest').on('click', function() {
            ga("send", {hitType: "event",eventCategory: "Button",eventAction: "Click Link Request",eventLabel: "Link Request"})
