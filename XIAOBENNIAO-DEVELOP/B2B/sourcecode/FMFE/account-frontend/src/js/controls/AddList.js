(function ($,X) { 
  ...
  X.prototype.controls.widget("AddList",function (controlType) {  
      ...
      AddList.prototype.generateSearchMeta = function() {
        var columns    = this.options.gridMeta.columns,
            simple     = [],
            searchMeta = {
              schema: {
                simple: simple
      ...
      AddList.prototype.loadTemplate = function() {
          var me = this
          this.elem.append(this.templates()).append('<div class="js-datagrid addList-showProductList"></div>')
      ...
      AddList.prototype.templates = function() {
          var productTemplate = [
            ...
            '           <div class="screen_search_box fix js-searchbox inlineb tar pr30 fr"></div>',
            ...
            '           <span class="ml20 colOrange curp" eventType="_eventAddProduct"><i class="iconfont icon-add mr5"></i>添加新产品</span>',
            '       </div>',
            '    </div>',
      ...
      AddList.prototype.separateColumns = function() {
          var showColumns   = [],
              checkColumns  = [],
              columns       = this.options.gridMeta.columns
      ...
      AddList.prototype.valueChanged = function(input) {
          ...
          this.inputHidden.val(validVal).valid()
      }
      ...
      AddList.prototype._eventAddProduct = function() {
          window.X.router.run('m=customerClearance.addDeclareProduct', '')
      }
      ...
      AddList.prototype.setValue = function() {
