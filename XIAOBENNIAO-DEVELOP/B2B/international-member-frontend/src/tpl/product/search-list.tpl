<div style="margin-top: -108px;">
    <div style="background: url('images/productList_p.jpg') no-repeat center center;height:432px" class="js-searchListImg">
        ...
        <div class="innerContent pt30">
            <p class="colff f35 Raleway pt165 bold ml210" data-i18n="searchList_Findtheright">FIND THE RIGHT PRODUCTS QUICKLY AND EASILY</p>
            <p class="colff f28 Raleway ml210" data-i18n="searchList_SearchAmong">Search among millions of products</p>
        </div>
    </div>
    <div class="innerContent mh480 por" style="margin-top: -150px">
        <div class="w88p center h140 bgcff mt75" style="border:1px solid #e8e8e8;box-shadow: 3px 3px 2px #ccc">
            <label class="searchBox cccBorder br5 disib h45 lh45 index-searchBox" style="margin:47px 45px; width: 63%">
                <input class="js-searchVal br5 h45 lh45" type="text" placeholder="searchList_Searchproduct"/>
                <a class="js-searchBtn ls2 col66 bgcOran colff borderLft h45 lh45" style="width:130px;border-radius: 0 5px 5px 0" data-i18n="product_search_title">Search</a>
            </label>
            <span class="f20 colcc va60 ml14">OR</span>
            <a href="" target="_blank" class="js-buttonRFQ f22 default_button w220 curp poa mt50 ml60" data-i18n="searchList_SubmitRFQ">Submit RFQ</a>
        </div>
        <div class="eeeBorder bgcff mt20 tac js-hotWords w97p ml10">
            <h2 class="col66 f18 mt30 mb30" data-i18n="searchList_hotWords">Hot Search Words</h2>
        ...
        <div class=" bgcff mt20 ">
            <div class="js_tabPannel1">
                ...
                <p class="f16 col66 js-total-num ml10 displayNone">
                    <span data-i18n="searchList_View">View</span>
                    <span class="js-view-num"> </span>
                    <span data-i18n="searchList_Product">Product(s) Below</span>
                </p>
                    ...
                    <div class="listWrap">
                        ...
                        <div class="js-searchRecommendNo displayNone">
                            <div class="eeeBorder bgcff mt_20  w97p ml10 h140 tac lh146">
                                <span class="mb30 f16 col66 inlineb ml20 " data-i18n="searchList_Ifyou">If you have demand for this product, try to send these requirements to our suppliers.</span>
                                <a href="" target="_blank"
                                   class="js-buttonRFQ f16 col66 disib curp search-no-result h38 lh38 lh40 w180 ml20"
                                   data-i18n="searchList_SubmitRFQ" style="border: 1px solid #e6e6e6">Submit RFQ</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div style="background: url('images/productListBanner2_p.jpg') no-repeat center  center;height:256px"
             class="mt30 js-productListBanner2Img">
            <p class="f35 colff tac pt40" data-i18n="searchList_Our">Our advanced search function</p>
            <p class="f35 colff tac" data-i18n="searchList_will">will help you find the right products</p>
            <p class="f35 colff tac" data-i18n="searchList_quickly">quickly and easily</p>
        </div>
    </div>
