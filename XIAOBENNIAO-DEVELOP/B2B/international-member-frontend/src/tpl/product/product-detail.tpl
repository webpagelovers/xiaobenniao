...
<div class="innerContent mh480 por mt20">
    ...
    <p class="f20 col66">
        <span data-i18n="productDetail_title" style="background:#526da4;" class="colff disib pl50 pr30 h40 lh40">Request Quotations for This Product</span>
    ...
    <!--position:relative;left:-41px"></span>-->
            <input class="h40 lh40 f16 js-serarchKeyword col33 w80p" type="text" placeholder="productDetail_searcgFor" style="background: #ededed">
        ...
        <div class="js-productDisplay por">
            ...
            <div class="fl ml60">
                ...
                <p class="poa w720" style="bottom:-20px">
                    <input type="button" class="fl productDetail-defBtn js-submitButton f22 default_button w300 curp mt40 bgcOran" data-i18n="productDetail_submitRequest"/>
    ...
    <div class=" bgcff mt20 ">
        <p class="col66 tac f35 pt30 mb34 js-prompt-mayAlso">
            ...
            <span  class="ml90 mr90 " data-i18n="productDetail_mayAlso">You may also be interested in</span>
            <span class="col99 f20">——————————————</span>
        </p>
        <p class="col66 tac f35 pt30 mb34 js-prompt-Buyerslike displayNone">
            <span class="col99 f20">——————</span>
            <span  class="ml90 mr90  " data-i18n="productDetail_Buyerslike">Buyers like you are purchasing these hot products</span>
            <span class="col99 f20">——————</span>
        </p>
    ...
    <div style="background: url('images/productDetailBanner.jpg') no-repeat center  center;height:242px" class="mt50">
        <p class="f35 colff tac pt40 ls2" data-i18n="productDetail_global">The Safest Place for Global Trade</p>
        <p class="f35 colff tac " data-i18n="productDetail_find">Find suppliers and trade services you can trust</p>
        <p class="tac"><input type="button" class="js-postButton f22 default_button w300 curp mt40 bgcOran " data-i18n="productDetail_postRequest"/></p>
    </div>
</div>
...
<div style="display: none;" class="js-layer-learn-more" >
    ...
    <div id="layerMainLearnMore" class="text-center">
        <div class="inlineb ver_top inlineb tal layer-flexslider-right js-layer-flexslider-right js-center" style="width: 950px;overflow-y: auto">
            <p class="mb10"><label class="inlineb f20 mr10 colff ml10" data-i18n="productDetail_name">Product Name:</label></p>
            ...
            <p class="mb10 js-description-content"><label class="inlineb f20 mr10 colff ml10" data-i18n="productDetail_description">Description:</label></p>
