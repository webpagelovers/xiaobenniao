    ...
    <form class="pl136 pt50 pb95 js-additional-form">
        <div class="mb30 ">
            ...
            <div class="inlineb por">
                ...
                <input type="text" class="br5 h36 lh36 shadow-input w310" placeholder="agent-additionalInfo-city-placeholder" name="location" maxlength="128" data-property-name="location" data-control-type="TextBox">
        ...
        <div class="mb30">
            ...
            <div class="inlineb">
                <input type="text" name="company" maxlength="128" placeholder="agent-additionalInfo-companyName-placeholder" class="br5 h36 lh36 shadow-input w410" data-property-name="company" data-control-type="TextBox">
            </div>
        </div>
        <div class="mb30">
            <span class="f14 mr15 tar w110 disib">Years of Working</span>
            <div class="inlineb">
                <input type="text" name="workingYears" placeholder="agent-additionalInfo-YearsofWorking-placeholder" maxlength="128" class="br5 h36 lh36 shadow-input w410" data-property-name="workingYears" data-control-type="TextBox">
        </div>
        </div>
