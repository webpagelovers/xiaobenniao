    ...
    X.prototype.controls.widget("Searcher", function (controlType) {
        ...
        function Searcher(elem, options) {
            ...
            function initOptions(options) {
                var defaultOption = {
                    "search": {"title": $.i18n.prop('controls_search')},
                    "reset": {
                        "title": $.i18n.prop('controls_reset'), "show": true, "onReset": function () {
                        }
                    },
                    "switch": {"title1": $.i18n.prop('controls_senior'), "title2": $.i18n.prop('controls_streamline')}
                };
        ...
        Searcher.prototype.getHtml = function (schema, options) {
            ...
            if (schema.simple && $.isArray(schema.simple)) {
                ...
                if (options["reset"]["show"]) {
                    //重置reset
                    opHtml += '<input type="button" class="reset_button ml30 js-reset" value="'+ $.i18n.prop('controls_reset') +'"><dt></dl>';
                }
