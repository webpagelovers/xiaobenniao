(function ($, X) {
    ...
    DAYS = [$.i18n.prop('controls_mon'),$.i18n.prop('controls_tue'), $.i18n.prop('controls_wed'),$.i18n.prop('controls_thu'),$.i18n.prop('controls_fri'), $.i18n.prop('controls_sat'), $.i18n.prop('controls_sun')];

    //MONTHS = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
    MONTHS = [$.i18n.prop('controls_jan'),$.i18n.prop('controls_feb'), $.i18n.prop('controls_mar'), $.i18n.prop('controls_apr'), $.i18n.prop('controls_may'), $.i18n.prop('controls_jun'), $.i18n.prop('controls_jul'),$.i18n.prop('controls_aug'), $.i18n.prop('controls_sep'), $.i18n.prop('controls_oct'),$.i18n.prop('controls_nov'), $.i18n.prop('controls_dec')];
    ...
    DateRangePicker = (function () {
        ...
        DateRangePicker.prototype.initOptions = function (options) {
            ...
            if ($.isArray(innerOp)) {
                innerOp.unshift({"value": "0", "text": $.i18n.prop('controls_select'), "selected": "selected"}, {
                    "value": "",
                    "text": $.i18n.prop('controls_range')
                }, {"value": "", "text": $.i18n.prop('controls_start')}, {"value": "", "text": $.i18n.prop('controls_stop')})
        ...
        DateRangePicker.prototype.value = function (value) {
            if (value != undefined) {
                ...
                if (option.length > 0) {
                    ...
                    var text = range[0] + $.i18n.prop('controls_to') + range[1];
    ...
    Calendar = (function () {
        ...
        Calendar.prototype.draw = function () {
            ...
            this.$title.text("" + (this.visibleYear()) + $.i18n.prop('controls_year') + (this.nameOfMonth(this.visibleMonth())) + " ");
