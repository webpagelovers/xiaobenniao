X.define("modules.common.nav", ['model.userModel', 'modules.user.common'], function (userModel, common) {
    ...
    nav.loginRegist = function () {
        // loginView.bindShowView($('.js-signIn', view.el));
        // registView.bindShowView($('.js-joinFree', view.el));
        //loginView.bindSignOut($('.js-signOut', view.el));
        $('.js-signOut', view.el).click(function () {
        ...
        //     nav.loginSuccess(data)
        // })
        //
        // X.subscribe(X.CONSTANT.channel.registSuccess, loginView.userInfo)
        userModel.userInfo(function (res) {
            res.statusCode == X.CONSTANT.statusCode.SUCCESS && nav.loginSuccess(res.data[0]);
        })
        /*loginView.bindSignOut($('.js-signOut', view.el),
         function(){
