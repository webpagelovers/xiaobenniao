...
const PlanList = () => import(/* webpackChunkName: "logistics-plan" */ './planlist/index.vue');
const AddPlan = () => import(/* webpackChunkName: "logistics-plan" */ './addplan/index.vue');
const PlanDetail = () => import(/* webpackChunkName: "logistics-plan" */ './plandetail/index.vue');
