    ...
    <div>
        <div class="mT16">
            <nt-table :data="gcfsCommodityMidList" ref="mid" class="dialog_table">
                ...
                <nt-table-column prop="commodityName" label="产品名称"></nt-table-column>
        ...
        methods: {
            ...
            * 上面是添加产品及搜索
            ...
            clearData: function () {
                ...
                /*if (this.selectedData.length > 0 && this.gcfsCommodityMidList.length >= 0) {

                    let a = [].concat(this.gcfsCommodityMidList);
                    let b = [].concat(this.selectedData);
                    ...
                    this.gcfsCommodityMidList = b;

                }*/

                /*for (var i = 0; i < this.gcfsCommodityMidList.length; i++) {
                    for (var j = i + 1; j < this.gcfsCommodityMidList.length; j++) {
                        if (this.gcfsCommodityMidList[i].id == this.gcfsCommodityMidList[j].id) {
                            this.gcfsCommodityMidList.splice(j, 1);
                            j--;
                        }
                    }
                }*/
