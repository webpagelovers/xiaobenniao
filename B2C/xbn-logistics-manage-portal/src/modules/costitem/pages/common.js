...
const commonMixin = {
    data() {
        ...
        return {
            ...
            */
            ...
            listUrlHash: '#/costitem/list',
            detailUrlHash: '#/costitem/detail',
            addUrlHash: '#/costitem/add',
            updateUrlHash: '#/costitem/update',
            dialogId: null,
    ...
    methods: {
        //跳到列表页
        jumpList: function () {
            this.$router.push({path: '/costitem/list'});
        },

        //跳到增加页面
        jumpAdd: function () {
            this.$router.push({path: '/costitem/add'});
        },

        //跳到详情页面
        jumpDetail(index, row) {
            this.$router.push({path: '/costitem/detail?id=' + row.id});
        },

        //跳到修改页面
        jumpUpdate(index, row) {
            this.$router.push({path: '/costitem/update?id=' + row.id});
        },
        //多余显示省略号
