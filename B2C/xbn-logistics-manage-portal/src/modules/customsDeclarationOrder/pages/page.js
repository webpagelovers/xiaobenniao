...
const List = () => import(/* webpackChunkName: "logistics-cusDecOrder" */ './list.vue');
const changeCusDecOrder = () => import(/* webpackChunkName: "logistics-cusDecOrder" */ './changeCusDecOrder.vue');
const Detail = () => import(/* webpackChunkName: "logistics-cusDecOrder" */ './detail.vue');
