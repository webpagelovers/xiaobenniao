...
const StoreList = () => import(/* webpackChunkName: "logistics-plan" */ './storelist/index.vue');
const AddStore = () => import(/* webpackChunkName: "logistics-plan" */ './addstore/index.vue');
const StoreDetail = () => import(/* webpackChunkName: "logistics-plan" */ './storedetail/index.vue');
