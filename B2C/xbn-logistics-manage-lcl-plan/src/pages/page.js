...
const List = () => import(/* webpackChunkName: "logistics-plan" */ './list/index.vue');
const Add = () => import(/* webpackChunkName: "logistics-plan" */ './add/index.vue');
const Assign = () => import(/* webpackChunkName: "logistics-plan" */ './assign/index.vue');
const Detail = () => import(/* webpackChunkName: "logistics-plan" */ './detail/index.vue');
