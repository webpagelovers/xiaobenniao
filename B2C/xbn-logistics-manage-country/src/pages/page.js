...
const CountryList = () => import(/* webpackChunkName: "logistics-plan" */ './countrylist/index.vue');
const AddCountry = () => import(/* webpackChunkName: "logistics-plan" */ './addcountry/index.vue');
